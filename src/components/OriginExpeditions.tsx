    ...
    >
      ...
      <section>
        ...
        <p>
          ...
          Origin: thank you. This was a grassroots effort from start to finish,
          and it wouldn’t have existed without you.
        </p>
      </section>
      <section>
        <h2>Transfer of Assets</h2>
        <p>
          As part of formally closing down the organization, I’m in the process
          of donating remaining gear to another nonprofit that can put them to
          good use. Once that transfer is complete, I’ll update this page with
          the details.
        </p>
      </section>
      <section>
        <h2>What Lives On</h2>
        <p>
          Several of the digital field guides we created are still available for
      ...
      <section>
        ...
        <p>
          If you’re interested in starting a wilderness program of your own and
          would like input, feedback, or support, feel free to reach out. I’ve
          added a <Link to="/contact">contact page</Link> on this site for
          exactly that reason — I’m always happy to help others carry this kind
          of work forward.
        </p>
      </section>
