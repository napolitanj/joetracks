    ...
    <section className="category-page">
      ...
      <section className="category-intro">
        <p>
          ...
          hundreds of people to the outdoors across the U.S. My work has ranged
          from youth wilderness education to private mountaineering clients —
          always with a focus on safety, preparation, and transformative
          experience. I hold certifications from <strong>AMGA</strong>,{" "}
          <strong>NOLS</strong>, and
      ...
      <section className="pillars">
        <div className="pillar">
          ...
          <ul>
            ...
            <li>Directed a ski mountaineering expedition to Alaska (2019).</li>
            <li>
        ...
        <div className="pillar">
          ...
          <ul>
            <li>
              Advised individuals and organizations on trip planning, equipment
            ...
            <li>
              Built logistics systems, SOPs, and field-ready frameworks adopted
              by summer camps.
            </li>
          </ul>
        </div>
        ...
        <article className="case-card">
          ...
          <div className="case-body">
            ...
            <p>
              ...
              thousands of organic views, helping climbers prepare responsibly.
            </p>
