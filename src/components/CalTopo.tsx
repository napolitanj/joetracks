            ...
            <Reveal variant="up" delay={100}>
              ...
              <section className="dis-row g-2">
                <div className="section-half">
                  ...
                  <p className=" fadeIn">
                    ...
                    basics of Caltopo’s interface not only allows you to embark
                    on a journey well-informed but also allows you to leave
                    folks back home with a comprehensive plan if you go missing.
                    Thus, learning CalTopo will enable you to better plan and
                    executes excursions while vastly increasing your margin of
                    safety.
                  </p>
                  <p className=" fadeIn">
                    With dozens of valuable features, learning how to use
                    CalTopo can appear to be a daunting task. Fear not; we’ve
                    taken the time to consolidate its most valuable aspects into
                    a quick and easy guide. The information on this page will
                    help you build an understanding of CalTopo’s interface so
                    you can get back to planning your trip and head outside!
                  </p>
                  <p className=" fadeIn">
                    <em>
              ...
              <section id="tour-caltopo-interface" className="dis-col">
                ...
                <div>
                  <p>
                    Head over to {""}
                    <a href="http://www.caltopo.com/" target="_blank" rel="noopener noreferrer">
                      www.caltopo.com
                    </a>
                    {""} in a separate window where you’ll see CalTopo’s
                    interface open to its default appearance pictured below. If
                    you have created an account and used CalTopo before, it will
                    open to your last-used map position and settings.
                  </p>
                  <p>
                  ...
                  <div className="section-half">
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        (inches, feet, miles, etc.), select the dropdown menu
                        next to "units" and select "Imperial."
                      </p>
                      <p>
              ...
              <section className="dis-row g-2">
                <div className="sqs-html">
                  ...
                  <p>
                    ...
                    see the dropdown menu in the picture. It's important to note
                    that CalTopo's interface will not save this information for
                    you. If you wish to keep the information, use the {""}
              ...
              <section className="dis-col">
                <div className="sqs-html">
                  ...
                  <p>
                    CalTopo's Distance tool displays the length of a line drawn
                    on the map. {""}
                    <a
                ...
                <div id="add-object" className="section-half">
                  <div>
                    ...
                    <p>
                      ...
                      dropdown menu pictured. This menu offers many of the same
                      options as the Measure tool, with additional features to
                      customize your map. Most importantly, using the +Add tool
                      allows you to save your work. You can use these tools to
                      create detailed maps like the one pictured below.
                    </p>
                  </div>
                  <figure>
                    <div>
                    ...
                    <figcaption className="image-caption-wrapper">
                      <div className="image-caption">
                        <p className="sqsrte-small">
                          ...
                          and campsites day-by-day. Each line can be selected to
              ...
              <section id="draw-a-route-caltopo" className="dis-col g-2">
                ...
                <div className="dis-row g-2">
                  <div className="section-half">
                    <p>
                      To draw a route, use the “Measure: Distance/Profile” tool
                      or the '“+Add: Line” tool. You’ll see a number of shaded
                      yellow lines appear that follow roads and trails as seen
                      in the picture. You can click on one of these lines to
                      “snap” your route to it.
                    </p>
                    <p>
                      ...
                      features. For example, hover your mouse over the image to
                      see how selecting “Hydro” allows you to snap your route to
                      waterways.
                    </p>
                    <p>
              ...
              <section id="change-caltopo-appearance" className="dis-col g-2">
                <div className="sqs-html">
                  ...
                  <p>
                    ...
                    learning proficiency with CalTopo is building an
                    understanding of its Map Layers feature.
                  </p>
                  <p>
                    In short, Caltopo’s Map Layer feature allows you to change
                    the appearance of your map. This allows you to gather a more
                  ...
                  <p>
                    The Caltopo Base Layer determines the appearance of the map
                    on your screen. You’ll notice that there’s a dropdown menu
                    with several map layer options. Below we’ve outlined some of
                    the most commonly used layers.
                  </p>
                </div>
                <div className="dis-row g-2">
                  <div>
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        Service (USFS). Generally, it resembles the Scanned Topo
                        layer but can include or exclude information depending
                        on the location. For this reason, it can be helpful to
                        examine both layers when considering travel in
                        undeveloped areas.
                      </p>
                    </div>
                  </div>
                  <div>
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        understood visualization of a particular area. This
                ...
                <div>
                  <p>
                    ...
                    others are offered in the free version of CalTopo with many
                    more in paid plans. Notably, {""}
              ...
              <section id="stacking-layers" className="dis-col g-2">
                <div>
                  ...
                  <p>
                    ...
                    comes to building a well-rounded understanding of the
              ...
              <section className="dis-col g-2">
                <div>
                  ...
                  <p>
                    In addition to Base Layers, CalTopo’s Map Layers menu offers
                    a list of options you can select to add additional features
                    to your map. You can see the three we find most useful below
                    by hovering over the Scanned Topo map of Black Canyon of the
                ...
                <div className="dis-row g-2 cnt">
                  ...
                  <div className="section-half">
                    ...
                    <p>
                      ...
                      beneficial in determining the terms by which you can
              ...
              <section id="export-caltopo-map" className="dis-col g-2">
                ...
                <div className="dis-row g-2">
                  <div className="section-half">
                    ...
                    <p>
                      ...
                      📏 on the left side of your interface. The export option
                      is located in the map objects window, which you will need
                      to open if you collapsed it earlier.
                    </p>
                    <p></p>
                  </div>
                  <figure className="section-half">
                ...
                <div className="dis-row g-2 cnt">
                  ...
                  <div className="section-half">
                    ...
                    <p>
                      ...
                      somewhat limited with the free account, and for the sake
                      of learning, we'll only cover a few.
                    </p>
                    <p>
                ...
                <div>
                  ...
                  <p>
                    Choose between landscape and portrait. If you're generating
                    a PDF, it allows you to create several pages at once.
                  </p>
                </div>
                <div className="dis-row g-2">
                  <div className="dis-col g-2">
                    <div>
                      ...
                      <p>
                        ...
                        features to be imported to your handheld GPS or
                        smartphone applications like GAIA GPS and Avenza Maps.
                        You can also import KML files on Google Earth. This is
                        an excellent way to visualize your route before heading
                        out into the backcountry and create outstanding graphics
                        for a trip itinerary.
                      </p>
                    </div>
                    <figure>
                      <img
                      ...
                      <div>
                        <div className="sqs-html">
                          ...
                          <p>
                            ...
                            file to your handheld or other applications, a topic
                            that we'll cover in a future guide.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div>
                  <div className="sqs-html">
                    ...
                    <p>
                      ...
                      tools for planning trips and allows you to leave folks at
                      home with a detailed plan. While picking a hike from a
                      menu from an application AllTrails can be easy, there is a
                      novelty to using CalTopo's tools to plan a trek of your
                      own.
                    </p>
                    <p>
                      Take the time to practice what you've learned, build a
                      route and get out there and hike! Be sure to share this
                      page with others you believe would value the information,
                      and subscribe below to stay up to date when we release new
                      guides.
                    </p>
                  </div>
                </div>
