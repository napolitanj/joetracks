        ...
        jsonLd={[
          {
            ...
            "@type": "WebPage",
            name: "Remote Forecasting Tools for Backcountry Snow Travel",
            description:
              "Use NOHRSC, SNOTEL, SWE, and satellite layers to assess snow conditions remotely and plan safer backcountry trips.",
