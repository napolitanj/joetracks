        ...
        <main className="container" id="page" role="main">
          <article className="sections">
              ...
              <div className="dis-row sneffels-intro">
                ...
                <div className="intro-text section-half">
                  ...
                  <p>
                    ...
                    northwest from the 14,157-foot summit of Mount Sneffels
                    before "dog-legging" northeast and steepening into a narrow
                    choke. Shortly after the choke, the couloir opens into a
                    wide apron that leads further into a massive basin –
                    resulting in up to 3000 vertical feet of skiing if you
                    choose to descend to Wilson Creek. Accessing the snake
                    couloir requires a long approach, a 30-foot pitch of class 4
                    scrambling in ski/board boots and a mandatory 100-foot
                    rappel.
                  </p>
            ...
            <Reveal variant="up" delay={140}>
              ...
              <p className="preFade">
                <em>
                  Origin Expeditions is not responsible for what any
                  individual(s) might choose to do with this information.
                </em>
              </p>
              <hr className="section-divider" />
              </section>
                      ...
                      <figcaption className="image-caption-wrapper">
                        <div className="image-caption">
                          <p className="sqsrte-small preFade">
                            Two slings around large rocks on the southwest side
                            of the summit, backed up by 1” tubular webbing we
                    ...
                    <ul>
                      ...
                      <li>
                        <p className="preFade">
                          ...
                          down-climbing in snow. I recommend two 35m, 6-7mm
                          ropes if you’ve got them - the 70m was heavy.
                        </p>
                      </li>
                      <li>
                    ...
                    <div className="block-content">
                      <div id="beta" className="dis-col">
                        ...
                        <p className="preFade">
                          ...
                          Evan's rappel and then removed it for my descent as
                          the cords seemed solid. Because this anchor is located
                          about 10 feet from the edge, I highly recommend a 70m
                          rope. Rumor has it that there are fixed bolts on the
                          summit, but I could not find any.
                        </p>
                        <p className="preFade">
                        ...
                        <p className="preFade">
                          ...
                          they begin plowing from Camp Bird to the pit toilet
                          just north of Stoney Mountain (it was clear by May 4th
                          in 2017). This year, the road was closed over a mile
                          east of Camp Bird, resulting in a considerably longer
                          tour.
                        </p>
                        <p className="preFade">
                        ...
                        <p className="preFade">
                          ...
                          (even before they plowed the road). In 2019 they were
                          not; I'm guessing 2017 was a fluke. If you're planning
                          on camping at the trailhead, be sure to bring what you
                          need to dispose of waste. You can harvest water from a
                          couple of different locations on the approach. As
                          Yankee Boy sees plenty of traffic, I recommend water
                          purification. I had exhausted 1.5 liters of water by
                          the time we had ascended back to the base of Lavender
                          Couloir - bring more if you think you'll need it.
                        </p>
                        <p className="preFade">
                          <strong>Exit:</strong>
                        </p>
                        <p className="preFade">
                          ...
                          is to trend skiers right out of the couloir to a band
                          of cliffs (see the picture below). Depending on how
                          much snow there is, you can descend through the
                          cliffs. Otherwise, ski around the cliff band and
                          traverse skiers right, maintaining as much elevation
                          as you can. You then must ascend 1000 feet back to the
                          saddle at the base of Lavender Couloir. We were both
                          exhausted by the time we were making this ascent.
                          Depending on the time of year, you might be able to
                          shuttle a car and follow Wilson Creek out.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <figcaption className="image-caption-wrapper">
                      <div className="image-caption">
                        <p className="sqsrte-small preFade">
                          ...
                          traverse. Alternatively, descend skiers left around
                          the cliffs and traverse high above the lower group of
                          turns in the photograph.
                        </p>
                      </div>
                    </figcaption>
                  </figure>
                      ...
                      <div className="row row">
                        <div className="dis-row g-2">
                          <div className="dis-col section-half">
                            <p className="preFade">
                              I woke in my car at 4 am, which I had parked about
                              a half-mile from the road closure. I immediately
                              turned my car on and blasted heat into my ski
                              boots, which I had positioned beneath the front
                              passenger vents the night before. I saw the light
                              in Evan's car turn on as I simultaneously dressed,
                              ate and hydrated. Once ready, we both drove our
                              cars to the parking area closer to the closure.
                            </p>
                            <p className="preFade">
                              ...
                              preparations. I carried my skis over my shoulder
                              as the first half mile past the closure was a dirt
                        ...
                        <div className="block-content">
                          <div className="html-content">
                            <p className="preFade">
                              ...
                              You'll pass a bridge on the left that leads to the
                              Wheel of Fortune Mine. A quarter-mile after this
                              point, you can continue to follow the road, or if
                              you're feeling confident, stay high and shoot
                              through the trees to save some time. Meet the road
                              again and follow it west to the pit toilet.
                            </p>
                            <p className="preFade">
                              As I reached the pit toilet, I was able to see a
                              party of four ascending the slope to my right; I
                              assumed to ski Teakettle Mountain. I also noticed
                              a group of three further ahead headed towards
                            ...
                            <p className="preFade">
                              ...
                              large hill and past an almost entirely buried sign
                              that marks the summer trailhead for Mount
                              Sneffels. Less than a half-mile further, we
                              arrived at the base of Sneffels's south apron. At
                              this point, we had completed roughly 6 miles and
                              3,600 vertical feet of elevation gain.
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="col col-6 span-6">
                          <div className="html-content">
                            <p className="preFade">
                              ...
                              skin to the lower saddle. Upon reaching the top, a
                            ...
                            <p className="preFade">
                              Two years ago, our party boot-packed the couloir,
                              a cold, waist-deep hell. This time around, we
                              elected to keep our skins during our entire
                              ascent. Even with plenty of tricky kick-turns,
                              this ended up being a considerably less miserable
                              way to the top. Upon reaching the upper saddle, I
                              slapped on my crampons and grabbed my ice ax to
                              prepare for what I consider to be the route's
                              crux.
                            </p>
                          </div>
                        </div>
                          ...
                          <figcaption className="image-caption-wrapper">
                            <div className="image-caption">
                              <p className="sqsrte-small preFade">
                                ...
                                southeast face. The party ahead is seen skinning
                                to the lower saddle where the Lavender Couloir
                                begins.
                              </p>
                            </div>
                          </figcaption>
                            ...
                            <div className="block-content">
                              <div className="html-content">
                                <p className="preFade">
                                  ...
                                  portion would be doable without crampons, I
                                  was happy to have mine. The adze of my ice ax
                                  was invaluable for chopping away at the snow,
                                  which was primarily faceted and useless for
                                  kicking steps. You’ll also be doing this
                                  portion in your ski/board boots with the rest
                                  of your equipment on your backpack banging
                                  into the rocks above you.
                                </p>
                                <p className="preFade">
                                ...
                                <p className="preFade">
                                  ...
                                  the ascent by skinning climbers left out of
                                  the couloir about two-thirds the way up. While
                                  also a viable option, this route spares you no
                                  exposure to a high-consequence tumble down the
                                  southeast face of the mountain. Judging from
                                  the appearance of their tracks, the snow on
                                  this variation was sun-baked and firm.
                                </p>
                                <p className="preFade">
                                  I made my way to the top of the scramble while
                                  Evan stood clear of falling ice and choss.
                                  Once I gained the ridge, I proceeded along the
                                  mildly exposed traverse above the Birthday
                                  Chutes, minding the cornice to my right. Happy
                                  to have my crampons here, I elected to
                                  navigate above a rock outcropping that was the
                                  last tricky obstacle before the final steps to
                                  the summit.
                                </p>
                              </div>
                            </div>
                      ...
                      <div className="dis-row g-2">
                        <div className="section-half">
                          <p className="preFade">
                            ...
                            bolted anchor. After several minutes of no success,
                            I removed the rope and webbing from my pack and
                            rigged them to the existing anchor on the southwest
                            side of the summit (approximately 10 feet from the
                            top of the rappel).
                          </p>
                          <p className="preFade">
                            ...
                            Once clear, I collected my webbing and followed
                            suit. We pulled the rope and quickly transitioned to
                            ski. Along with most of the climbing and the rappel
                            behind us, gazing down the undisturbed and
                            tremendously aesthetic Snake Couloir inspired plenty
                            of excitement in both of us.
                          </p>
                        </div>
                      ...
                      <div className="dis-row g-2">
                        ...
                        <div className="section-half dis-col">
                          ...
                          <p className="preFade">
                            ...
                            the couloir. Powder! After several dozen
                            thigh-burning turns, I posted up behind the rock
                            island where the route dog-legs northeast and waited
                            for Evan to join me. Here the route steepens to what
                            I estimate is at least 50 degrees and proceeds into
                            a narrow choke. I took my time, minding any buried
                            rocks and&nbsp;
                            <a
                          ...
                          <p className="preFade">
                            ...
                            skiers right in search of a route along which we
                            could traverse to along the base of Sneffels’s north
                            face. Looking down into Blaine Basin, Evan and I
                            couldn’t help but agree - there was more skiing to
                            enjoy. Neglecting the opportunity to save ourselves
                            some misery, we enjoyed another thousand feet of
                            skiing into the bowl below.
                          </p>
                          <figure className="block-image-figure intrinsic">
                            <div className="image-shape-container-element has-aspect-ratio">
                              <img
                      ...
                      <div className="dis-row g-2">
                        <div className="section-half">
                          <p className="preFade">
                            ...
                            were eight hours into our day and still far from the
                            end on account of our decision to ski far into the
                            basin rather than traverse. We were feeling the burn
                            right away as we began skinning back towards
                            Sneffels. Making our way looker’s left, we
                      ...
                      <div className="dis-row g-2">
                        <div className="section-half">
                          <p className="preFade">
                            ...
                            advantage of long sections of snow alongside the
                            road to ski.
                          </p>
                          <p className="preFade">
                            In conclusion, the route totaled 15.5 miles and
                            7,168 vertical feet over 13 hours and 50 minutes.
                            Here's a short video of footage I gathered along the
                            way.
                          </p>
                          <p className="preFade">
                            Thanks for taking the time to read. Enjoy the video
                            below if you're looking for more visual detail from
                            our trip. Please share this guide with anyone you
                            feel would value the information. Be safe out there!
                          </p>
                        </div>
                        <div className="section-half">
                          <figure className="block-image-figure intrinsic">
