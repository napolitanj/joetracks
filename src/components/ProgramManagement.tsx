    ...
    <section className="category-page">
      ...
      <section className="category-intro">
        <p>
          ...
          infrastructure (Slack, Google Workspace, website), led staff/volunteer
          onboarding, managed inventory and risk, and built feedback loops to
          measure outcomes. The constant theme: make complex operations simple,
          safe, and repeatable.
        </p>
      </section>
      ...
      <section className="stat-grid">
        <div className="stat">
          <span className="stat-num">+$20,000</span>
          <span className="stat-label">Grants & donations secured</span>
        </div>
        <div className="stat">
          <span className="stat-num">4 Wilderness Programs</span>
        ...
        <article className="case-card">
          ...
          <div className="case-body">
            ...
            <p>
              ...
              recruited & trained volunteers, and directed the trips. Post-trip
              surveys fed an improvement loop for the next cohort.
            </p>
      ...
      <section className="category-cta">
        <p>
          Want a lightweight, repeatable program framework for your org? I can
          help you stand it up quickly and document it so anyone can run it.
        </p>
